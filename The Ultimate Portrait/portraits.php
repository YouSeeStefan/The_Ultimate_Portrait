      ...
      while ($loop->have_posts()) : $loop->the_post();
        ...
        ?>
          <div class="results_text">
            ...
            <p class="textBig"><?php echo $textBig . "...";?><a href="<?php echo $singlePageLink; ?>" class="readmore">Read more</a></p>
            <p class="textMedium"><?php echo $textMedium . "..." ?><a href="<?php echo $singlePageLink; ?>" class="readmore"> Read more</a></p>
